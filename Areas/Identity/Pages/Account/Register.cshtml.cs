        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.FrontEndUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.FrontEndUser));
                    }
                    ...
                    {
                        if (Role == SD.FrontEndUser)
                        {
                            await _userManager.AddToRoleAsync(user, SD.FrontEndUser);
                        }
                        else
                        {
