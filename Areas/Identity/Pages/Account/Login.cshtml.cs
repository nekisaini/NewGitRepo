        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    List<ShoppingCart> lstShopping = await _db.ShoppingCart.Where(x => x.ApplicationUserId == user.Id).ToListAsync();
                    HttpContext.Session.SetInt32("ssShoppingCartCount", lstShopping.Count);
